    ...
    <section class="bg-blue-900 py-16 text-white">
        <div class="container px-4 md:px-6">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <p class="mt-4 text-blue-100 md:text-xl">Conoce más sobre ALTIMO, nuestro compromiso con la excelencia y
            ...
            <div class="grid gap-12 md:grid-cols-2">
                <div>
                    ...
                    <div class="space-y-4 text-gray-600 text-lg">
                        <p>Somos el <b>Centro de Cirugía Ambulatoria más moderno de Santa Ana</b>, respaldado por un equipo médico de <b>gran trayectoria y amplia experiencia</b>, ofreciendo así unas instalaciones modernas, equipadas, con un personal capacitado para <b>brindar la mejor atención</b> haciendo sentir al paciente de forma <b>especial y única.</b></p>
                    </div>
                </div>
                <div class="flex items-center justify-center"><img alt="Instalaciones de ALTIMO" loading="lazy"
                        ...
                        src="https://admin-altimo.gunssoft.tech/wp-content/uploads/2025/09/Edificio2-scaled-e1757734412469.jpg" style="color: transparent;"></div>
            </div>
        </div>
    </section>
        ...
        <div class="container px-4 md:px-6 max-w-[1300px] mx-auto">
            <div class="grid gap-8 md:grid-cols-3 text-lg">
                <div class="rounded-lg bg-white p-6 shadow-sm">
                    ...
                    <p class="text-gray-600">Ser el mejor centro de cirugía ambulatoria en la zona occidental del país, comprometidos con la excelencia en la atención humanizada de nuestros clientes externos e internos mejorando la calidad de vida.</p>
                </div>
                <div class="rounded-lg bg-white p-6 shadow-sm">
                    <h3 class="mb-4 text-xl font-bold text-gray-900">Visión</h3>
                    <p class="text-gray-600">Llegar a ser la primera opción en centro de cirugía ambulatoria en la zona occidental del país.</p>
                </div>
                <div class="rounded-lg bg-white p-6 shadow-sm">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        ...
                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                <path d="m9 11 3 3L22 4"></path>
                            </svg><span>Honestidad y transparencia</span></li>
                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-circle-check-big mt-0.5 h-5 w-5 shrink-0 text-blue-600">
                        ...
                        <li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                <path d="m9 11 3 3L22 4"></path>
                            </svg><span>Confidencialidad y seguridad</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container px-4 md:px-6 max-w-[1300px] mx-auto">
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div><img alt="Recepción" loading="lazy" width="400" height="250" decoding="async" data-nimg="1"
                        class="mb-4 rounded-lg object-cover" src="https://admin-altimo.gunssoft.tech/wp-content/uploads/2025/09/Edificio2-scaled-e1757734412469.jpg"
                        style="color: transparent;">
                ...
                <div><img alt="Sala de Tomografía" loading="lazy" width="400" height="250" decoding="async"
                        ...
                        src="https://admin-altimo.gunssoft.tech/wp-content/uploads/2025/09/Edificio3-1-scaled-e1757734484228.jpg" style="color: transparent;">
                ...
                <div><img alt="Sala de Ultrasonido" loading="lazy" width="400" height="250" decoding="async"
                        data-nimg="1" class="mb-4 rounded-lg object-cover"
                        src="https://admin-altimo.gunssoft.tech/wp-content/uploads/2025/09/Edificio1-scaled-e1757732531402.jpg" style="color: transparent;">
