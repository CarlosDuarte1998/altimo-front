            ...
            <div v-else class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    ...
                    <div class="relative h-[280px] overflow-hidden">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-300 pointer-events-none">
                        </div>

                        <div
                            class="absolute bottom-0 left-0 right-0 p-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300 pointer-events-none z-10">
                    ...
                    <div class="p-5 flex-1 flex flex-col hover:bg-gray-50 transition-colors">
                    ...
                    <div
                        class="absolute top-4 right-4 w-10 h-10 bg-white rounded-xl shadow-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform scale-0 group-hover:scale-100 pointer-events-none z-10">
                ...
                <div v-if="instalaciones.length === 0" class="col-span-full text-center py-8">
...
// Función para calcular el delay de autoplay con efecto dominó
const getAutoplayDelay = (index: number): number => {
    // Velocidades diferentes para cada card (efecto dominó)
    // Card 1: 2000ms, Card 2: 2300ms, Card 3: 2600ms, etc.
...
<style scoped>
/* Estilos para el carrusel interno de imágenes de cada card */
.instalacion-images-swiper {
    width: 100%;
    height: 280px;
    overflow: hidden;
}

.instalacion-images-swiper :deep(.swiper-wrapper) {
    height: 280px;
}

.instalacion-images-swiper :deep(.swiper-slide) {
    height: 280px;
    display: flex;
    align-items: center;
...
/* Desactivar interacción del usuario con el carrusel de imágenes (solo visual) */
.instalacion-images-swiper :deep(.swiper) {
    pointer-events: none;
    user-select: none;
}

.instalacion-images-swiper img {
    pointer-events: none;
    user-select: none;
}
</style>