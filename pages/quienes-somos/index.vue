<template class="flex flex-col items-center justify-center gap-4 px-4 py-8 md:px-6 lg:px-8 max-w-[1380px] mx-auto">
            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <div class="text-center">
                    <div class="mx-auto mb-4 h-40 w-40 overflow-hidden rounded-full">
                        <img alt="Dr. Roberto Martínez" loading="lazy" width="160" height="160" decoding="async"
                    ...
                    <p class="mt-2 text-sm text-gray-600">Doctor en Cirugía Dental y Empresario con amplia trayectoria
                        en el sector salud. Fundador del Centro de Especialidades Dentales CLIDESA, del Centro de
                        Imágenes Médicas CIMRO y del Centro Médico Áltimo.</p>
                </div>
                <div class="text-center">
                    <div class="mx-auto mb-4 h-40 w-40 overflow-hidden rounded-full">
                        <img alt="Dra. María Elena García" loading="lazy" width="160" height="160" decoding="async"
                            data-nimg="1" class="h-full w-full object-cover"
                    ...
                    <p class="mt-2 text-sm text-gray-600">Especialista en Cirugía General, Endoscópica, Bariátrica y
                        Metabólica, con 23 años de experiencia. Cuenta con diversidad de cursos y diplomados que
                        respaldan su formación y trayectoria en el área quirúrgica.</p>
                </div>
                <div class="text-center">
                    <div class="mx-auto mb-4 h-40 w-40 overflow-hidden rounded-full">
                        <img alt="Dra. Ana Sofía López" loading="lazy" width="160" height="160" decoding="async"
                            data-nimg="1" class="h-full w-full object-cover"
                    ...
                    <p class="mt-2 text-sm text-gray-600">Especialista en Medicina Interna, con 15 años de experiencia y
                        estudios de posgrado que respaldan su formación profesional.</p>
                </div>
                <div class="text-center">
                    <div class="mx-auto mb-4 h-40 w-40 overflow-hidden rounded-full">
                        <img alt="Dr. Carlos Hernández" loading="lazy" width="160" height="160" decoding="async"
                            data-nimg="1" class="h-full w-full object-cover"
                    ...
                    <p class="text-sm text-gray-500">Regente Médico</p>
                    <p class="mt-2 text-sm text-gray-600">Especialista en Medicina Interna, con 25 años de experiencia,
                        con participación en diversidad de congresos que fortalecen su formación y actualización en la
                        práctica médica.</p>
                </div>
            </div>
        </div>
  ...
  <div class="container px-4 md:px-6 max-w-[1300px] mx-auto">
    ...
    <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
      <!-- Miembro 1 -->
      <div class="text-center">
        <div class="mx-auto mb-4 h-40 w-40 overflow-hidden rounded-lg shadow-md">
          <img
            alt="Dr. Roberto Martínez"
            loading="lazy"
            width="160"
            height="160"
            decoding="async"
    ...
    <section class="bg-gray-50 py-16">
        <div class="container px-4 md:px-6 max-w-[1300px] mx-auto">
            ...
            <div v-else class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <NuxtLink v-for="instalacion in instalaciones" :key="instalacion.id"
