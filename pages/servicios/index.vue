<template>
    ...
    <section class="py-16">
        <div class="container max-w-[1300px] mx-auto px-4 md:px-6">
            <div class="mt-6">
                <!-- Loading State -->
                <div v-if="typedCategoriesStore.isLoading">
                ...
                <!-- Error State -->
                <div v-else-if="typedCategoriesStore.error" class="text-center">
                        ...
                        >
                            ...
                            <div class="p-6 pt-0">
                                <img 
                                    ...
                                    :src="category.imagen_url || 'https://dummyimage.com/350x200?text=Sin+Imagen'" 
...
// Computed para filtrar categorías (excluir Perfiles con ID 25)
...
const handleImageError = (event: Event) => {
  ...
  target.src = 'https://dummyimage.com/350x200?text=Sin+Imagen'
}
