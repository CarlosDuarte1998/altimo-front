...
<template>
            ...
            <div class="grid gap-10 md:grid-cols-2">
                <div>
                    ...
                    <div v-if="configStore.isCurrentlyLoading" class="space-y-6">
                        <div
                            class="rounded-lg border border-gray-200 bg-card text-card-foreground shadow-sm animate-pulse">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        ...
                                        <a :href="`https://wa.me/${contactInfo.whatsapp.replace(/[^0-9]/g, '')}`"
                                            target="_blank" class="hover:text-blue-600 transition-colors">
                    ...
                    <div class="mt-8" v-if="!configStore.isCurrentlyLoading">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                            <!-- Tasa 0 -->
                            <div
                                class="flex flex-col items-center text-center p-6 rounded-2xl bg-[#213364] text-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
                                <div
                                    class="mb-4 w-14 h-14 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                                    <UIcon name="i-heroicons-percent-badge" class="w-7 h-7 text-white" />
                                </div>
                                <h4 class="text-base font-semibold mb-1 text-white">Tasa 0%</h4>
                                <p class="text-sm text-white/80">Sin intereses</p>
                            </div>
                            ...
                            <div
                                ...
                                <div
                                    class="mb-4 w-14 h-14 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                                    <UIcon name="i-heroicons-credit-card" class="w-7 h-7 text-white" />
                                </div>
                                <h4 class="text-base font-semibold mb-1 text-white">Tarjetas</h4>
                                <p class="text-sm text-white/80">Nacional e internacional</p>
                            </div>
                            ...
                            <div
                                ...
                                <div
                                    class="mb-4 w-14 h-14 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                                    <UIcon name="solar:card-transfer-broken" class="w-7 h-7 text-white" />
                                </div>
                                <h4 class="text-base font-semibold mb-1 text-white text-center leading-snug">
                                    Transferencias nacionales e internacionales
                                </h4>
                                <p class="text-sm text-white/80">Bancarias</p>
                            </div>
                            ...
                            <div
                                ...
                                <div
                                    class="mb-4 w-14 h-14 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                                    <UIcon name="nimbus:gift-card" class="w-7 h-7 text-white" />
                                </div>
                                <h4 class="text-base font-semibold mb-1 text-white">Certificado prepago</h4>
                                <p class="text-sm text-white/80">Código o enlace</p>
                            </div>
                        </div>
                            ...
                            <form class="space-y-4" @submit.prevent="handleSubmit">
                                <div class="space-y-2">
                                    ...
                                    <input v-model="formData.firstname"
                                        ...
                                        id="nombre" placeholder="Tu nombre completo" required name="nombre" type="text">
                                </div>
                                <div class="space-y-2">
                                    <label
                                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                    ...
                                    <input v-model="formData.email"
                                        class="flex h-10 w-full rounded-md border border-gray-300 border-input bg-background px-3 py-2 text-base placeholder:text-muted-foreground md:text-sm"
                                        id="email" placeholder="tu@email.com" required type="email" name="email">
                                </div>
                                <div class="space-y-2">
                                    <label
                                        class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                    ...
                                    <input v-model="formData.contact"
                                        class="flex h-10 w-full rounded-md border border-gray-300 border-input bg-background px-3 py-2 text-base placeholder:text-muted-foreground md:text-sm"
                                        id="telefono" placeholder="Tu número de teléfono" required name="telefono"
                                        type="tel">
                                </div>
                                <div class="space-y-2">
                                    <label
                                    ...
                                    <input v-model="formData.subject"
                                        ...
                                        id="asunto" placeholder="Asunto de tu mensaje" required name="asunto"
                                        type="text">
                                </div>
                                <div class="space-y-2">
                                    <label
                                    ...
                                    <textarea
                                        ...
                                        required v-model="formData.message">
                                    </textarea>
                                </div>
                                ...
                                <button
                                    ...
                                    type="submit" :disabled="contactStore.isLoading">
                                    <UIcon v-if="contactStore.isLoading" name="i-lucide-loader-2"
    ...
    <Transition enter-active-class="transition ease-out duration-300"
        ...
        <div v-if="showSuccessToast"
            class="fixed top-4 right-4 z-50 max-w-sm bg-green-500 text-white p-4 rounded-lg shadow-lg">
    ...
    <Transition enter-active-class="transition ease-out duration-300"
        ...
        <div v-if="showErrorToast"
            class="fixed top-4 right-4 z-50 max-w-sm bg-red-500 text-white p-4 rounded-lg shadow-lg">
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-red-100 mt-1">Por favor, inténtalo de nuevo o contacta con nosotros
                        directamente.
                    </p>
                </div>
